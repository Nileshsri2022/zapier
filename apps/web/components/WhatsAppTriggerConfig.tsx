...
const WhatsAppTriggerConfig = ({ zapId, onTriggerCreated }: Props) => {
  ...
  const eventTypes = [
    ...
    },
    {
      ...
      description: 'Trigger when your message is delivered',
    },
    {
      value: 'message_read',
      label: 'Message Read',
      description: 'Trigger when your message is read',
    },
  ];
            ...
            <div key={trigger.id} className="bg-white p-4 rounded-lg shadow-md">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Account: {trigger.server?.displayName}</p>
