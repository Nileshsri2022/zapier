...
const ZapCell = ({
  ...
  return (
    <div
      className={`w-[25rem] animate-slide_in bg-base-100 shadow-md hover:shadow-lg transition-all rounded-md border border-dashed border-gray-700 p-4 hover:border-solid hover:border-secondary-500`}
    >
